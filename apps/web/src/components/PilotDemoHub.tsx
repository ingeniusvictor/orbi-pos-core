    ...
    <main className="pilot-hub">
      <section className="pilot-hub-hero">
        ...
        <div className="pilot-hub-summary">
          ...
          <div className="pilot-hub-hero-actions">
            ...
            <button type="button" className="ghost" onClick={() => go('/piloto/migracion')}>
              Runbook migración
            </button>
            <button type="button" className="ghost" onClick={() => go('/piloto/evidencia')}>
              Evidencia / incidentes
            </button>
            <button type="button" className="ghost" onClick={() => go('/piloto/expedientes')}>
              Expedientes
            </button>
            <button type="button" className="ghost" onClick={() => go('/piloto/respaldo')}>
      ...
      <footer className="pilot-hub-footer">
        ...
        <div className="pilot-footer-actions">
          ...
          <button type="button" className="ghost" onClick={() => go('/piloto/migracion')}>Runbook migración</button>
          <button type="button" className="ghost" onClick={() => go('/piloto/evidencia')}>Evidencia</button>
